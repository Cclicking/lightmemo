...
internal object DefaultRecognitionPrompts {
        val SYSTEM_PROMPT = """
            ...
            用户指定食物名称是识别菜品的强提示；若有指定名称，以它作为主要识别对象，用图片核对组成和份量，不要无依据改成其他菜品。
            若本餐说明包含“两人份”或“三人份”，先按图片中的整份食物估计总可食用重量，应用会在识别完成后换算为单人份。
        ...
        val TEXT_SYSTEM_PROMPT = """
            ...
            用户指定的食物名称和本餐说明是识别输入的一部分；名称用于确定识别对象，说明中的“两人份”或“三人份”表示描述的是供多人分食的整份食物，先估计整份总重量，应用会在识别完成后换算为单人份。
