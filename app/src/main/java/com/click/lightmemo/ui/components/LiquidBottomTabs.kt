...
import com.click.lightmemo.ui.effects.edgelight.edgeLight
import com.click.lightmemo.ui.effects.edgelight.rememberDefaultEdgeLight
import com.click.lightmemo.ui.effects.liquidglass.DampedDragAnimation
import com.click.lightmemo.ui.effects.liquidglass.InteractiveHighlight
import com.click.lightmemo.ui.utils.isAppDarkTheme
...
fun LiquidBottomTabs(
    ...
    BoxWithConstraints(
        ...
        val latestSelection by rememberUpdatedState(selectedTabIndex)
        ...
        val dampedDragAnimation = remember(animationScope) {
            DampedDragAnimation(
                ...
                onDragStopped = {
                    ...
                    latestOnTabSelected(targetIndex)
